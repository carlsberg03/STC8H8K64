...
#define OLED_SCL_PIN  P74		
#define OLED_SDA_PIN  P75
#define OLED_REST_PIN P76		//液晶复位引脚定义
#define OLED_DC_PIN   P77   	//液晶命令位引脚定义
#define OLED_CS_PIN   P47   	//定义SPI_CS引脚
...
void oled_p6x8str(uint8 x,uint8 y,const int8 ch[]);//显示字符串
void oled_p6x8num(uint8 x,uint8 y,uint16 num);//显示整数
void oled_p6x8float(uint8 x,uint8 y,float num);//显示浮点数
void oled_p6x8str_inv(uint8 x,uint8 y,uint8 ch[]);//反色显示字符串
