...
//使用内部6MHz晶振
//#define FOSC          		    6000000	    //FOSC的值设置为6Mhz
//#define EXTERNAL_CRYSTA_ENABLE 	0			//使用外部晶振，0为不使用，1为使用

//使用外部12MHz晶振
#define FOSC           			12000000	//FOSC的值设置为0，则自动读取系统频率										
#define EXTERNAL_CRYSTA_ENABLE 	1			//使用外部晶振，0为不使用，1为使用
